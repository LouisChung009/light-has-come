...
## ✅ 已完成項目
- [x] **Next.js 專案初始化**: 安裝與設定完成
- [x] **Tailwind CSS v4**: 設定完成
- [x] **設計系統**: 
  - 品牌色彩 (金、珊瑚、藍、薄荷綠)
  - 字體設定 (標題: jf-openhuninn, 內文: ZCOOL XiaoWei)
  - 基礎動畫 (FadeIn, Float, Pulse)
- [x] **首頁開發**: 
  - Hero 區塊
  - 核心價值
  - 課程預覽
...
- [x] **分頁開發**:
  - 活動花絮頁 (`/gallery`) - 含篩選功能
  - 課程介紹頁 (`/courses`) - 含分齡介紹
  - 預約報名頁 (`/register`) - 含表單邏輯
  - 關於我們頁 (`/about`) - 含團隊介紹
- [x] **響應式設計**: 手機版適配優化

## 🚧 進行中
- [x] **Vercel 部署**: 網站已上線 (等待網址確認)

## 📝 待辦事項
1. **後端整合**: Supabase 資料庫設定 (未來規劃)
2. **圖片替換**: 使用真實活動照片
3. **SEO 優化**: 補充各頁面 metadata
- [ ] 照片上傳與管理
